...
function setupCSV() {
    var stream = fs.createWriteStream("div" + whatDivision + GradYear + ".txt");
...
function save(saveData, newLine = false) {
    var stream = fs.createWriteStream("div" + whatDivision + GradYear + ".txt", {flags: 'a'});
    stream.once('open', function(fd) {
    if(newLine != false) {
